...
CONDPROB_DIR = os.environ.get("CONDPROB_DIR", os.path.join(BASE_DATA_DIR, "condprob_new"))
...
OUT_DIR      = os.environ.get("CONDPROB_OUT_DIR", os.path.join(BASE_DATA_DIR, "condprob_pred_new"))
CHUNKSIZE    = 200_000
TOPK         = 5
